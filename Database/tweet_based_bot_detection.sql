...
--
-- Host: localhost
-- Generation Time: Nov 15, 2021 at 10:59 AM
...
--
-- Database: `tweet_based_bot_detection`
--
CREATE DATABASE IF NOT EXISTS `tweet_based_bot_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `tweet_based_bot_detection`;
...
--
-- Table structure for table `remote_user_tweet_message`
--

CREATE TABLE IF NOT EXISTS `remote_user_tweet_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idno` varchar(300) NOT NULL,
  `Tweet` varchar(30000) NOT NULL,
  `following` varchar(300) NOT NULL,
  `followers` varchar(300) NOT NULL,
  `actions` varchar(300) NOT NULL,
  `is_retweet` varchar(300) NOT NULL,
...
--
-- Table structure for table `remote_user_tweet_type_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_tweet_type_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idno` varchar(300) NOT NULL,
  `Tweet` varchar(30000) NOT NULL,
  `following` varchar(300) NOT NULL,
  ...
  `is_retweet` varchar(300) NOT NULL,
  `location` varchar(300) NOT NULL,
  `tweet_type` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
