"""tweet_based_bot_detection URL Configuration
...
from tweet_based_bot_detection import settings
...
urlpatterns = [
    ...
    url(r'^Find_Tweet_Type_Ratio/$', serviceprovider.Find_Tweet_Type_Ratio, name="Find_Tweet_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Predict_Tweet_Type/$', serviceprovider.Predict_Tweet_Type, name="Predict_Tweet_Type"),
